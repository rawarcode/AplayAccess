...
<div class="cards"><div class="card"><div class="lbl">Total Bookings</div><div class="val">${dateBookings.length}</div></div><div class="card"><div class="lbl">Total Guests</div><div class="val">${totalGuests}</div></div><div class="card"><div class="lbl">Revenue Collected</div><div class="val" style="font-size:13pt">${fmtM(totalRevenue)}</div><div class="hint">Completed + forfeited fees</div></div><div class="card"><div class="lbl">Gross Total</div><div class="val" style="font-size:13pt">${fmtM(grossTotal)}</div><div class="hint">All bookings</div></div></div>
