...
import { loginUser, setSession } from '../utils/appData';
...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-6 relative" 
             style={{ 
                 background: '#f0f7fb',
                 background: 'radial-gradient(circle at 10% 30%, #d4e9f5, #f8ffff)'
             }}>
            ...
            <div className="relative z-20 bg-white rounded-[48px] shadow-2xl max-w-4xl w-full flex flex-wrap overflow-hidden border border-[#e2edf2]"
                ...
                <div className="flex-1 min-w-[280px] bg-[#f9fcfe] p-12 flex flex-col justify-between border-r border-[#e2edf2]">
                    ...
                    <div className="text-[#6b8cae] font-light text-sm border-t border-dashed border-[#cde3ea] pt-6">
                        ...
                        16 coastal countries · 200+ beaches
                    </div>
                </div>
                ...
                <div className="flex-1 min-w-[340px] bg-white p-12">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <button 
                            type="submit" 
                            className="w-full py-4 bg-[#1e3a8a] text-white rounded-[60px] font-medium text-xl shadow-lg border border-[#bce2ee] flex items-center justify-center gap-3 transition-all hover:bg-[#152c6e] hover:-translate-y-0.5 hover:shadow-xl"
                    ...
                    <div className="mt-8 flex flex-col items-center gap-3">
                        ...
                        <div className="text-center text-xs text-[#6b8cae]">
                            Demo: frontdesk@aplayaccess.com / Aplaya123!
                        </div>
                    </div>
                </div>
            </div>
