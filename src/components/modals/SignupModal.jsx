...
export default function SignupModal({ open, onClose, onSignedUp }) {
  ...
  async function submit(e) {
    ...
    try {
      ...
      // Store token and notify parent with real user
        ...
        <div className="p-6 sm:p-8">
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <label className="flex items-start gap-2 text-sm text-gray-700">
              ...
              <span>
                I agree to the{" "}
                <a href="#" className="font-medium text-blue-600 hover:text-blue-500">Terms and Conditions</a>{" "}
                and{" "}
          ...
          <p className="text-center mt-5 text-sm text-gray-600">
            ...
            <span className="font-medium text-blue-600">Use the Login button.</span>
          </p>
        </div>
      </Modal>

      <AlertModal open={alert.open} onClose={closeAlert} type={alert.type} title={alert.title} message={alert.message} />
    </>
  );
}
