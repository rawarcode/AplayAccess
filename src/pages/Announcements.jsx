  ...
  return (
    <div className="pt-16 bg-gray-900 min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {loading ? (
            ...
            <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
              {[...Array(3)].map((_, i) => (
                <div key={i} className="bg-gray-800 rounded-2xl overflow-hidden shadow-lg animate-pulse">
            ...
            <div className="text-center py-20 text-gray-400">
              <div className="w-20 h-20 rounded-full bg-gray-800 flex items-center justify-center mx-auto mb-4">
                <i className="fas fa-bullhorn text-3xl text-gray-600"></i>
              </div>
            ...
            <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
              {announcements.map((item, i) => (
                <div
                  key={item.id}
                  className="group relative bg-gray-800 rounded-2xl overflow-hidden shadow-lg flex flex-col hover:-translate-y-1 transition-all duration-300 ring-1 ring-gray-700 hover:ring-blue-500/40 animate-hero-fade-in opacity-0"
                  style={{ animationDelay: `${Math.min(i * 0.1, 0.8)}s` }}
                >
                  {/* Hover glow */}
                  <div className="absolute -inset-[2px] rounded-2xl bg-gradient-to-r from-blue-500 via-cyan-400 to-blue-600 opacity-0 group-hover:opacity-15 blur-xl transition-opacity duration-500 -z-10" />
      ...
      {selected && (
        ...
        >
          <div className="bg-gray-800 rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl animate-hero-fade-in [animation-delay:0s] opacity-0">
            {/* Media */}
            {selected.media_url && (
